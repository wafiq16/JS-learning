...
export declare const LIST_DIRECTIVES: {
    'child-src': string;
    'connect-src': string;
    'default-src': string;
    'font-src': string;
...
export declare const STRING_DIRECTIVES: {
    'base-uri': string;
    'report-uri': string;
};
export declare const BOOLEAN_DIRECTIVES: {
    'block-all-mixed-content': string;
    'upgrade-insecure-requests': string;
};
export declare const ALLOWED_DIRECTIVES: {
    'block-all-mixed-content': string;
    'upgrade-insecure-requests': string;
    'base-uri': string;
    'report-uri': string;
